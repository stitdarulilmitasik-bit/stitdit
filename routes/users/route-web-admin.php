...
Route::group(['prefix' => 'web-admin', 'middleware' => ['checkUser:web'], 'as' => 'web-admin.'],function(){
    ...
    Route::get('/maintenance/migrate', [App\Http\Controllers\Private\User\MaintenanceController::class, 'migrate'])->name('maintenance.migrate');
    Route::post('/maintenance/migrate', [App\Http\Controllers\Private\User\MaintenanceController::class, 'runMigrations'])->name('maintenance.migrate.run');
