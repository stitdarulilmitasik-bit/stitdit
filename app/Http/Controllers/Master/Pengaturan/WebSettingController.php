    ...
    public function handleSettings(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('school_logo_vert')) {
                ...
                if ($settings->getRawOriginal('school_logo_vert') && $settings->getRawOriginal('school_logo_vert') !== 'logo-vert.png') {
                    Storage::disk('public')->delete('images/logo/' . $settings->getRawOriginal('school_logo_vert'));
                }
            ...
            if ($request->hasFile('school_logo_hori')) {
                // Delete old logo if exists
                if ($settings->getRawOriginal('school_logo_hori') && $settings->getRawOriginal('school_logo_hori') !== 'logo-hori.png') {
                    Storage::disk('public')->delete('images/logo/' . $settings->getRawOriginal('school_logo_hori'));
                }
