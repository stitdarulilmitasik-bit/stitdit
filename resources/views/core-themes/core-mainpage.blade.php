<html lang="id" data-bs-theme="light" data-bs-theme-primary="green">
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                <div class="card">
                                    ...
                                    <div class="card-body scroll-y p-2" style="max-height: 50vh">
                                        <div class="row g-0">
                                            <div class="col-4">
                                                <a href="{{ route('root.siakad') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('root.e-learning') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('root.perpustakaan') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('root.laboratorium') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('root.kemahasiswaan') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                                            ...
                                            <div class="col-4">
                                                <a href="{{ route('root.keuangan') }}" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
                            ...
                            <div class="d-none d-xl-block ps-2">
                                <div>{{ ($user ?? null) == null ? 'Guest' : $user->name }}</div>
                                <div class="mt-1 small text-secondary">{{ ($user ?? null) == null ? 'Guest' : $user->type }}</div>
                            </div>
                        </a>
                ...
                <div class="navbar">
                    <div class="container-xl">
                        <div class="row flex-column flex-md-row flex-fill align-items-center">
                            <div class="col">
                                <!-- BEGIN NAVBAR MENU -->
                                @include('core-themes.components.main-menu')
                                <!-- END NAVBAR MENU -->
                            </div>
</div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8 text-lg-start text-center">
                        <ul class="list-inline list-inline-dots mb-0">
                            <li class="list-inline-item">Copyright © {{ \Carbon\Carbon::now()->translatedFormat('F Y') }} <a href="." class="link-secondary">Siakad STIT Darul Ilmi. Seluruh hak cipta dilindungi.</li>
