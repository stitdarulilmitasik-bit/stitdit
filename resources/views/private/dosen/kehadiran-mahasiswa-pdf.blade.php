...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .kop-logo img { width: 114px; height: 114px; object-fit: contain; }
    ...
    .footer { position: fixed; left: 0; right: 0; bottom: -9mm; border-top: 1px solid #777; padding-top: 3px; text-align: center; font-size: 6.5pt; color: #555; } .footer .page:after{content:"Halaman " counter(page) " dari " counter(page);}
