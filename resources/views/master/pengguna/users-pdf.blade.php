...
<head>
<meta charset="UTF-8">
<title>DAFTAR PENGGUNA - STIT Darul Ilmi Tasikmalaya</title>
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .footer .page:after { content: "Halaman " counter(page) " dari " counter(page); }
...
<div class="title">
    <div class="title-main">DAFTAR PENGGUNA</div>
...
<table class="data">
    ...
    <tbody>
        ...
        @empty
            <tr><td colspan="5" style="text-align:center;padding:12px;">Tidak ada data pengguna.</td></tr>
        @endforelse
    </tbody>
</table>
