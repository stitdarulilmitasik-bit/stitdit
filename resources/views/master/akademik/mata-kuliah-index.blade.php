                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Nama Mata Kuliah">
                                            <div class="d-flex flex-column">
                                                ...
                                                <small class="text-muted">{{ $item->programStudi?->name ?? 'Program Studi belum ditentukan' }}</small>
                                            </div>
                                        </td>
                                        <td data-label="Kode">{{ $item->code }}</td>
                                        <td data-label="Program Studi">{{ $item->programStudi->name ?? 'Program Studi belum ditentukan' }}</td>
