...
@section('custom-css')
    <style>
        ...
        .hero-section {
            background: linear-gradient(135deg, rgba(var(--tblr-info-rgb), 0.7), rgba(var(--tblr-primary-rgb), 0.8)) no-repeat center center;
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <figure class="featured-image">
                            <div class="ratio">
                                <img src="{{ stit_news_image_url($berita->photo) }}" alt="{{ $berita->name }}" loading="lazy" onerror="this.onerror=null;this.src='{{ news_fallback(1200,675,'Gambar Berita') }}'">
                            </div>
                    </figure>
                    ...
                    @if($relatedBerita->count() > 0)
                        <div class="sidebar-card">
                            ...
                            @foreach($relatedBerita as $related)
                                @php $rimg = $related->photo ? stit_news_image_url($related->photo) : news_fallback(200,200,'Berita'); @endphp
