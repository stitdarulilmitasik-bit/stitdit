...
@section('custom-css')
    <style>
        ...
        .hero-section {
            background: linear-gradient(135deg, rgba(var(--primary-color-rgb), 0.96), rgba(var(--accent-color-rgb), 0.92)) no-repeat center center;
...
@section('content')
    ...
    <section class="hero-section text-center text-white">
        <div class="container hero-content">
            <h1 class="display-1 fw-bold mb-4">STIT Darul Ilmi Tasikmalaya</h1>
                ...
                @empty
                    <div class="col-12">
                        <div class="card border-0 shadow-sm p-5 text-center">
                            <div class="text-muted">Data program studi belum tersedia.</div>
                        </div>
                    </div>
                @endforelse
            </div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="card h-100 border-0 shadow-sm overflow-hidden">
                ...
                <img
                    src="{{ stit_news_image_url($featuredBerita->photo) }}"
                ...
                <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex-shrink-0" style="width: 130px;">
                            ...
                            <img
                                src="{{ stit_news_image_url($berita->photo) }}"
                                alt="{{ $berita->name }}"
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex-shrink-0" style="width:130px;">
                            <div class="ratio ratio-16x9 rounded overflow-hidden">
                            <img src="{{ news_fallback(320,180,'Berita') }}" class="w-100 h-100 object-fit-cover" alt="Placeholder berita STIT Darul Ilmi">
                            </div>
                        </div>
                        <div class="flex-grow-1">
                            <div class="d-flex align-items-center gap-2 mb-1">
            ...
            <div class="row g-4">
                ...
                @else
                    <div class="col-12 text-center py-5">
                        ...
                        <p class="text-muted mb-4 col-md-6 mx-auto">Galeri foto kampus akan segera hadir untuk menampilkan kegiatan dan fasilitas STIT Darul Ilmi Tasikmalaya.</p>
                        <a href="{{ route('root.galeri-index') }}" class="btn btn-primary">
                            Lihat Galeri
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon ms-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none">
                                <path d="m9 18 6-6-6-6"></path>
